...
<body>
    ...
    <?php
                ...
                $offset = ($page - 1)* $limit;
                $sr = 1;
                    $query = "select * from post left join category on post.category=category.category_id left join user on post.author= user.user_id order by post_id DESC limit {$offset},{$limit}";
